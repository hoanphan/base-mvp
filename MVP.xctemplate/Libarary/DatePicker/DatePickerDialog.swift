...
//    private var maximumDate:    NSDate?
    ...
    public func show(title: String, doneButtonTitle: String = "Chọn", cancelButtonTitle: String = "Hủy", defaultDate: Date = Date(), minimumDate: Date? = nil, maximumDate: Date? = nil, datePickerMode: UIDatePickerMode = .dateAndTime, callback: @escaping DatePickerCallback) {
        ...
        //NotificationCenter.default.addObserver(self, selector: #selector(DatePickerDialog.deviceOrientationDidChange(_:)), name: UIDeviceOrientationDidChangeNotification, object: nil)
    ...
    public func showCustomDialog(title: String, doneButtonTitle: String = "Chọn", cancelButtonTitle: String = "Hủy", callback: @escaping DatePickerCallback) {
        self.titleLabel.text = title
        self.doneButton.setTitle(doneButtonTitle, for: .normal)
        self.cancelButton.setTitle(cancelButtonTitle, for: .normal)
        self.callback = callback
